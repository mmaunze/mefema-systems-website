  ...
  <section class="bg-white dark:bg-gray-900">
    ...
    >
      <div class="col-span-2 mb-8">
        ...
        >
          Mantenha sua tecnologia sempre em pleno desempenho com nossa
          expertise.
        </h2>
        <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
          Oferecemos um suporte técnico completo para otimizar e manter a
          eficiência da sua infraestrutura tecnológica
        </p>
        <div
      ...
      >
        <div>
          ...
          <h2 class="mb-2 text-2l font-bold dark:text-white">
            Serviços de Helpdesk e Consultoria
          </h2>
          <p class="font-light text-gray-500 dark:text-gray-400">
            Oferecemos suporte técnico e consultoria especializada para resolver
            problemas e otimizar seu ambiente de TI.
          </p>
        </div>
        <div>
          <svg
          ...
          <h4 class="mb-2 text-2l font-bold dark:text-white">
            Gestão e Administração de Sistemas
          </h4>
          <p class="font-light text-gray-500 dark:text-gray-400">
            Monitoramos e gerenciamos seus sistemas para garantir performance e
            segurança.
          </p>
        </div>
        <div>
          ...
          <p class="font-light text-gray-500 dark:text-gray-400">
            Configuramos e implementamos redes seguras e eficientes para sua
            empresa.
          </p>
        </div>
        <div>
          ...
          <p class="font-light text-gray-500 dark:text-gray-400">
            Instalamos e mantemos seus equipamentos para garantir um
            funcionamento suave e contínuo.
          </p>
        </div>
      </div>
    </div>
